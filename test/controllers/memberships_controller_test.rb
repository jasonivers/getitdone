...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { owner_id: @membership.owner_id, owner_type: @membership.owner_type, user_id: @membership.user_id } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { owner_id: @membership.owner_id, owner_type: @membership.owner_type, user_id: @membership.user_id } }
